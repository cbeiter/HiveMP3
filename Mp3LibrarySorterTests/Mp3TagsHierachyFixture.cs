...
namespace HiveOrganizerTests
{
    ...
    public class Mp3TagsHierachyFixture
    {
        ...
        public void WhenAddingSongToAlbum()
        {
            ...
            _mp3ClassHierarchy.AddInformation(new Mp3Node { AlbumName = "Album2", ArtistName = "Artist", FileName = "fileName3" });
        ...
        {
            _mp3ClassHierarchy.AddInformation(new Mp3Node { AlbumName = "Album2", ArtistName = "Artist", FileName = "fileName3" });
            _mp3ClassHierarchy.AddInformation(new Mp3Node { AlbumName = "Album2", ArtistName = "Artist1", FileName = "fileName31" });
